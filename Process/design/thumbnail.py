...
async def thumb(thumbnail, title, userid, ctitle):
    ...
    image2 = Image.open("Process/source/LgcyAlex.png")
    ...
    font = ImageFont.truetype("Process/source/LgcyAlex.ttf", 85)
    font2 = ImageFont.truetype("Process/source/LgcyAlex.ttf", 60)
    draw.text(
        (20, 46),
        f"{title[:18]}...",
        fill="black",
